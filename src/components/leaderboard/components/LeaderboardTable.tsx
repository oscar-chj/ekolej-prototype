                  ...
                  >
                    ...
                    <Box sx={{ flex: 1, minWidth: 0 }}>
                      ...
                      <Typography
                        ...
                        noWrap
                      >
                        {entry.faculty} • Year {entry.year ?? 1}
                      </Typography>
                    </Box>
                    <Typography
                      variant="h6"
...
function getPointsByCategory(entry: LeaderboardEntry, category: string) {
  switch (category) {
    case "university":
      return entry.universityMerit;
    case "faculty":
      return entry.facultyMerit;
    case "college":
      return entry.collegeMerit;
    case "club":
      return entry.clubMerit;
    default:
    ...
    <Paper>
      <List sx={{ p: 0 }}>
        {[...Array(10)].map((_, index) => (
          <Box
            key={index}
            sx={{ py: 2, px: 2, display: "flex", gap: 2, alignItems: "center" }}
          >
